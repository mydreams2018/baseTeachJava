...
public class SSLEngineSimpleDemo {
    ...
    public SSLEngineSimpleDemo() throws Exception {
        ...
        sslCtx.init(kmf.getKeyManagers(), tmf.getTrustManagers(), SecureRandom.getInstance("SHA1PRNG"));
        sslc = sslCtx;
    }
    /*
     ...
     */
    private static String keyStoreFile = "C:\\Users\\kungreat\\dw.keystore";
    private static String passwd = "yjssaje";
    /*
    ...
    private void runDemo() throws Exception {
         ...
         */
        if (!isEngineClosed(clientEngine) || !isEngineClosed(serverEngine)) {
    ...
    private void createSSLEngines() throws Exception {
         ...
         */
        clientEngine = sslc.createSSLEngine("localhost", 80);
